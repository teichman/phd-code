...
int main(int argc, char** argv)
{
  ...
  opts_desc.add_options()
    ...
    ("detection-threshold,r", bpo::value(&detection_threshold)->default_value(0), "Foreground must be greater than this percent of the image to send a Foreground message.")

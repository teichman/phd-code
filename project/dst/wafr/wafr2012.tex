...
\newcommand{\media}{/home/teichman/sync/media}
\newcommand{\img}{\media/2011/11-11-20_cvpr2012}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{\img/headliner2/headliner2.pdf}
...
\begin{figure}
  \includegraphics[width=7cm]{\img/normals/normals.pdf}
  \sidecaption[t]
...
\subsection{Qualititative analysis}

\subsubsection{Strengths}

\begin{figure*}
  \centering
  \includegraphics[width=\linewidth]{\img/emu_caller/emu_caller-gs.pdf}
...
\begin{figure*}
  \centering
  \vspace{1cm}
  \includegraphics[width=\linewidth]{\media/2012/12-02-23_wafr_static_imagery/results/results-gs.pdf}

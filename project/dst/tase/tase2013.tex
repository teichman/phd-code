...
%\newcommand{\vga}{$640 \times 480$\xspace}
%\newcommand{\qqvga}{$160 \times 120$\xspace}
...
There are several reasons a complete solution to this task would be useful in robotics, computer vision, and graphics.  For example, 3D model capture in unstructured environments could be made possible.  In the following, however, we will focus on the area of object recognition.

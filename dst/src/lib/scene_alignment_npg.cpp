...
namespace dst
{
  ...
  void SceneAlignmentNPG::_compute()
  {
    ...
    KinectCloud::ConstPtr prev_pcd = index_otl_->pull().previous_pcd_;
    ...
    KinectCloud::ConstPtr transformed_pcd = transformed_otl_->pull();
    KinectCloud::ConstPtr curr_pcd = index_otl_->pull().current_pcd_;
